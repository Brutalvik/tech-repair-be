...
export const LOGO_URL = "https://infinitetechrepair.ca/logo.png";
...
const VERCEL_DOMAIN = "https://infinitetechrepair.ca";
...
export const generateBookingConfirmationHtml = (booking) => `
  ...
  booking.bookingDate
      ...
      <p style="text-align: center;">
          <a href="${VERCEL_DOMAIN}/track-repair?trackingId=${
  booking.trackingId
}" target="_blank" style="${baseStyles.button}">
              Track Your Repair
          </a>
      </p>
